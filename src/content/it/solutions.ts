// Testi italiani di src/content/solutions.ts (chiave = slug del blocco inglese).
// Bozza del 24 set 2026: la terminologia tecnica va riletta da Enfrio.
export const IT_SOLUTIONS: Record<string, string> = {
  solutions_seo_title: "Soluzioni Enfrio | Esecuzione 5P e sistemi di raffreddamento",
  solutions_seo_description:
    "Le soluzioni Enfrio per le aziende: project management, ingegneria, definizione dei processi, procurement e trasferimento in produzione.",
  ...
  solutions_offer_card1_text:
    "Radiatori acqua, radiatori olio, radiatori carburante e intercooler configurati sui cicli di lavoro specifici dell'applicazione.",
  solutions_offer_card2_title: "Soluzioni di raffreddamento per OEM",
  solutions_offer_card2_text:
    "Architetture su misura progettate per vincoli di ingombro, facilità di manutenzione e prestazioni produttive ripetibili.",
  solutions_offer_card3_title: "Pacchetti termici ad alta efficienza",
  solutions_offer_card3_text:
  ...
  solutions_execution_panel1_item3: "Progettazione orientata alla producibilità",
  solutions_execution_panel2_title: "Processo + Procurement + Trasferimento",
  solutions_execution_panel2_item1: "Definizione del processo industriale e cicli di validazione",
  solutions_execution_panel2_item2: "Coordinamento dei fornitori sui componenti critici",
